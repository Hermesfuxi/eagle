package bigdata.hermesfuxi.eagle.rule.service.router;

import bigdata.hermesfuxi.eagle.rule.buffer.BufferResult;
import bigdata.hermesfuxi.eagle.rule.buffer.RedisBufferManager;
...
public class QueryRouterV4 {
    ...
    // 缓存管理器
    private RedisBufferManager redisBufferManager;
